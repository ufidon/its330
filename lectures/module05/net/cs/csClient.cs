  ...
  { 
      if (args.Length == 2)
      {
            try 
            {
                ...
                Console.WriteLine("Client: Create TcpClient and connect to server {0}", server);
                ...
                Console.WriteLine("Client: I said '{0}' to the server {1}.", message, remoteIpEndPoint.Address);         
                ...
                Console.WriteLine("Client: Server {0} replied '{1}' to me", remoteIpEndPoint.Address, responseData);         

                // Close everything.
                stream.Close();         
                client.Close(); 
                Console.WriteLine("Client: I disconnected from Server {0}", remoteIpEndPoint.Address);        
            } 
