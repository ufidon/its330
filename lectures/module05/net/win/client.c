...
int __cdecl main(int argc, char **argv) 
{
    ...
    // Initialize Winsock
    printf("client: Initialize Winsock\n");
    ...
    printf("client: Resolve the server address and port\n");
    ...
    printf("client: Attempt to connect to the server.\n");
    ...
    do {
        ...
        if ( iResult > 0 ){
            printf("client: The server replied '%s' to me.\n", recvbuf);
